...
def dump_agent(agent_data, output_path):
    ...
    # UniV2X checkpoints retain six learned camera embeddings while V2X-Seq
    # supplies one front camera. The PyTorch broadcast path expands that camera
    # to six feature slots, so the calibration matrix follows the same contract.
