...
# keep backbone + neck + tracking head, disable map/motion/occ/planning heads.
for _agent_cfg in (model_other_agent_inf, model_ego_agent):
    _agent_cfg["seg_head"] = None
    _agent_cfg["occ_head"] = None
    _agent_cfg["motion_head"] = None
model_ego_agent["planning_head"] = None
