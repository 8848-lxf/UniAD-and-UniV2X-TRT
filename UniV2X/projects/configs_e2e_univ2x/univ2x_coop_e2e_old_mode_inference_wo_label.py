...
ann_file_test = info_root + f"spd_infos_temporal_test_numpy1.21.5.pkl"
command_file_test = info_root + f"spd_command_test.pkl"
...
data = dict(
    ...
    test=dict(
        ...
        file_client_args=file_client_args,
        data_root=data_root,
        inference_wo_label=True,
        command_file=command_file_test,
        test_mode=True,
        ann_file=ann_file_test,
        pipeline=test_wo_label_pipeline,
        patch_size=patch_size,
        canvas_size=canvas_size,
        bev_size=(bev_h_, bev_w_),
        predict_steps=predict_steps,
