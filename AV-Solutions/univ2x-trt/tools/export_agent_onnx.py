...
def main():
    ...
    parser.add_argument(
        "--agent-normalization-epsilon",
        type=float,
        default=0.0009765625,
        help=(
            "Agent-query inverse-sigmoid epsilon. The default 2^-10 is the "
            "validated finite TensorRT value; 1e-5 reproduces the source formula."
        ),
    )
