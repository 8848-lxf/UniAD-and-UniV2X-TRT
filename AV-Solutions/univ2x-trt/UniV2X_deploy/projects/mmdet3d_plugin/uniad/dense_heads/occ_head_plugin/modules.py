...
class BevFeatureSlicer(nn.Module):
    def __init__(self, grid_conf, map_grid_conf):
        ...
        if grid_conf == map_grid_conf:
            ...
            # UniV2X's infrastructure head intentionally uses the lateral
            # map coordinate for both normalized axes on its asymmetric BEV.
            # Preserve that checkpoint-time sampling contract exactly.
