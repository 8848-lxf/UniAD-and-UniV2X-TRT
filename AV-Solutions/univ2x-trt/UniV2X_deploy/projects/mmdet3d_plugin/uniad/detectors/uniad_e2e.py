...
class UniADTRT(UniADTrackTRT):
    ...
    def forward_uniad_trt(self,
                    ...
                    use_prev_bev=1.0,
                    max_obj_id=0,
                    coop_track_intances0=None,
                    coop_track_intances1=None,
                    coop_track_intances2=None,
                    coop_track_intances3=None,
                    coop_track_intances4=None,
                    coop_track_intances5=None,
                    coop_track_intances6=None,
                    coop_track_intances7=None,
                    coop_track_intances8=None,
                    coop_track_intances9=None,
                    coop_track_intances10=None,
                    coop_track_intances11=None,
                    coop_track_intances12=None,
                    coop_track_intances13=None,
                    coop_match_vehicle_index=None,
                    coop_other2ego_rt=None,
                    coop_lane_outputs_classes=None,
                    coop_lane_outputs_coords=None,
                    coop_lane_query=None,
                    coop_lane_query_pos=None,
                    coop_lane_reference=None,
                    coop_occ_pred_scores=None,
                    coop_ego2other_rt=None,
                    **kwargs):
        scene_token_changed = 1-use_prev_bev
        coop_track_instances = None
        if coop_track_intances0 is not None:
            coop_track_instances = [
                coop_track_intances0,
                coop_track_intances1,
                coop_track_intances2,
                coop_track_intances3,
                coop_track_intances4,
                coop_track_intances5,
                coop_track_intances6,
                coop_track_intances7,
                coop_track_intances8,
                coop_track_intances9,
                coop_track_intances10,
                coop_track_intances11,
                coop_track_intances12,
                coop_track_intances13,
            ]
        prev_track_intances = [
            prev_track_intances0,
            prev_track_intances1,
        ...
        (
            motion_query_embeddings,
            motion_track_scores,
            motion_track_labels,
            motion_gravity_center,
            motion_yaw,
        ) = self.pad_fixed_motion_queries_trt(
            track_query_embeddings,
            track_bbox_results1,
            track_bbox_results2,
            bboxes_gravity_center,
        ...
        (
            ...
            track_instances_fordet, with_mask=False
        )
        ...
        track_query_embeddings = motion_query_embeddings.float().detach()
        track_bbox_results1 = motion_track_scores.float().detach()
        track_bbox_results2 = motion_track_labels.long().detach()
        bboxes_gravity_center = motion_gravity_center.float().detach()
        bboxes_yaw = motion_yaw.float().detach()
        ...
        track_scores = \
            self.motion_head.forward_test_trt(
                ...
                lane_query,
                lane_query_pos)
        seg_gt, seg_out, occ_pred_scores, occ_pred_sigmoid =\
            ...
            other_occ_scores=coop_occ_pred_scores,
            ego2other_rt=coop_ego2other_rt,
        )
        if self.with_planning_head:
        ...
        outputs = (prev_track_intances0_out,
                prev_track_intances1_out,
                prev_track_intances2_out,
                prev_track_intances3_out,
                prev_track_intances4_out,
